...
describe("fenomenGonderimSayisi", () => {
  it("fenomenGonderimSayisi -> istenen fenomenin gönderim(posts) sayısını döndürür", () => {
    expect(functions.fenomenGonderimSayisi(fenomenler, "Will Smith")).toEqual(
      136
    );
  });
});
...
describe("platformaGoreCokGonderiYapanFenomen", () => {
  it("platformaGoreCokGonderiYapanFenomen ->  Verilen platform da en çok gönderi yapan fenomen adını döndürür", () => {
    expect(
      functions.platformaGoreCokGonderiYapanFenomen(fenomenler, "TikTok")
    ).toEqual("charli damelio");
  });
});
...
describe("platformaGoreCokGonderiYapanFenomen", () => {
  it("platformaGoreCokGonderiYapanFenomen ->  Verilen platform da en çok gönderi yapan fenomen adını döndürür", () => {
    expect(
      functions.platformaGoreCokGonderiYapanFenomen(fenomenler, "Twitter")
    ).toEqual("Justin Bieber");
  });
});
